...
int main()
{
	...
	Maze::TileKey mudMap[Maze::HEIGHT][Maze::WIDTH] = {
		{ w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w, w },
		{ w, _, _, _, _, _, _, _, s, s, s, s, s, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, s, s, s, s, s, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, s, s, s, s, s, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, s, s, s, s, s, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, g, _, _, _, _, s, s, s, s, s, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, s, s, s, s, s, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, s, s, s, s, s, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, s, s, s, s, s, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, s, s, s, s, s, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
	...
	game.setCurrentScene(game.addScene(new Maze(mudMap)));
